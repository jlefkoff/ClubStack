...
st.title(
    f"Member Profile: {st.session_state['first_name']} {st.session_state['last_name']}"
)
...
updated_join_date = st.date_input(
    "Join Date", value=datetime.strptime(st.session_state["join_date"], "%Y-%m-%d")
)
